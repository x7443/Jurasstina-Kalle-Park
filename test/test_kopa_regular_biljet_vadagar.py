...
def run(playwright: Playwright) -> None:
    ...
    # Väljer en Safari och ett datum under veckan för att köpa den och lägga till den i varukorgen.
    ...
    expect(page.get_by_text("T-Rex Rumble on 2026-12-14")).to_be_visible()
